    ...
    return (
      <div className={style.content}>
        ...
        <List renderHeader={() => '委托信息'} className="my-list">
          <Item extra={'2018-05-16 20:30'}>委托时间</Item>
          <Item extra={'600 CNY'}>委托本金</Item>
          <Item
            extra={
              <Badge text="买涨"
                style={{ marginTop: -2, padding: '0 3px', backgroundColor: '#3fc295', borderRadius: 2 }}
              />}
          >委托方向</Item>
          <Item extra={<span className="green">550 CNY</span>}>结算结果</Item>
        </List>
        <WhiteSpace size="xl" />
      </div>
    );
